...
def generate():
    ...
    if is_placeholder_key:
        if is_demo_request:
            ...
            return jsonify({
                "detail": "API credentials (CONTEXT_DEV_API_KEY, GROQ_API_KEY, FISH_API_KEY) are missing or set to defaults in .env. Configure valid keys in .env or try 'https://example.com/demo' for a preview broadcast."
            }), 502
